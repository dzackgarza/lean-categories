...
/-- The scale ideal of an integral lattice. -/
abbrev scaleIdeal (L : IntegralLatticeCat R) := scaleModule L
...
/-- The norm ideal generated by the values `b(x,x)`. -/
abbrev normIdeal (L : IntegralLatticeCat R) := valueModule L
