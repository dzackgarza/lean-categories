...
public import LeanCategories.CategoryGraph.Tools.ExportJson
public import LeanCategories.CategoryGraph.Specimen.Register
public import Lean.Data.Json

public meta import LeanCategories.CategoryGraph.Tools.ExportJson
...
run_cmd
  ...
  let baseline := CategoryGraph.Tools.snapshotManifestString
...
namespace CategoryGraph.Tools.ExportFull
...
def loadRegisteredSnapshot : IO RegistrySnapshot := do
  ...
  let env ← Lean.importModules
    #[{ module := `LeanCategories.CategoryGraph.Specimen.Register }] {}
    (loadExts := true)
