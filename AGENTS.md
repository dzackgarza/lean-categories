...
On 2026-08-13/14 an agent fleet lost ~24 hours in this repo and the research
preamble to one pathology: substituting a legible artifact for the goal and
then optimizing the artifact — the goal file itself, an error count, reviewer
verdicts, a "blocked" label, registry self-consistency. The rules below are
...
- **Two consecutive administrative turns is a tripwire.** If the previous turn
  ...
  paperwork is the signature of the failure this section exists to stop.
