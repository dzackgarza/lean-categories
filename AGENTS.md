...
| [`Vilin97/lean-pool`](https://github.com/Vilin97/lean-pool) | Lean Pool: an arXiv-like archive of independent Lean 4 formalizations outside Mathlib's scope, kept `sorry`-free and pinned to current Mathlib by linters and LLM review. Complementary to Tau Ceti; a reuse surface and a possible home for standalone results. |
