---
type: reference
title: "Provenance contract for FC11 C12"
description: "# Provenance contract for FC11 C12"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C12

## Provenance contract for FC11 C12

- Canonical source block: FC11 Peters–Sterk Chapter 12, “Integral Lattices: the Discriminant Form”, `FC11-C12-U001`–`FC11-C12-U043`, 43 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/43 successful, 43 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 1, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 42; total 43.
