---
type: reference
title: "Provenance contract for FC11 C13"
description: "# Provenance contract for FC11 C13"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C13

## Provenance contract for FC11 C13

- Canonical source block: FC11 Peters–Sterk Chapter 13, “The Spin Group”, `FC11-C13-U001`–`FC11-C13-U034`, 34 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/34 successful, 34 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 3, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 31; total 34.
