---
type: reference
title: "Provenance contract for FC11 C08"
description: "# Provenance contract for FC11 C08"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C08

## Provenance contract for FC11 C08

- Canonical source block: FC11 Peters–Sterk Chapter 8, “Inner Product Spaces Over Fields”, `FC11-C08-U001`–`FC11-C08-U019`, 19 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/19 successful, 19 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 4, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 15; total 19.
