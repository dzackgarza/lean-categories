...
- 2026-09-13 U083–U108 refresh: current Mathlib `H=87befc843c2b3a1be12f7fe9ba274d212b544348` still has no algebraic-geometric blowup (`ReesAlgebra.lean` retains only the future-work comment) and no Cohen structure theorem. The local smoothness API does contain a cotangent-complex Jacobian criterion and open/dense smooth loci, while adic completion contains locality, Krull-intersection injectivity, exactness on finite modules, tensor-product realization, residue-field preservation, and cotangent-rank preservation. No pinned/current theorem equating Krull dimension before and after completion was found. The mapping now credits each of those clauses and leaves only the explicit missing bridges/results unmatched.
