---
type: reference
title: "Provenance contract for FC11 C11"
description: "# Provenance contract for FC11 C11"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C11

## Provenance contract for FC11 C11

- Canonical source block: FC11 Peters–Sterk Chapter 11, “Normal Forms and the Genus”, `FC11-C11-U001`–`FC11-C11-U024`, 24 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/24 successful, 24 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 24; total 24.
