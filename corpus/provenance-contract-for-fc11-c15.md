---
type: reference
title: "Provenance contract for FC11 C15"
description: "# Provenance contract for FC11 C15"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C15

## Provenance contract for FC11 C15

- Canonical source block: FC11 Peters–Sterk Chapter 15, “Lattice Embeddings”, `FC11-C15-U001`–`FC11-C15-U030`, 30 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/30 successful, 30 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 30; total 30.
