---
type: reference
title: Foundational corpus units FC02 Munkres
description: '# FC02 — Munkres, *Topology*'
tags:
- project
- reference
...
# FC02 — Munkres, *Topology*

Corpus source: `FC02` in [[foundational-source-corpus|Foundational source corpus v1 (frozen)]].

Pinned source: James R. Munkres, *Topology*, 2nd ed., Prentice Hall, 2000; complete book, exercises excluded.

Markdown extraction: `/home/dzack/Zotero/storage/CZQDCAJR/local-write-api-1783249491889-EEDYK7RG_extracted.md`.
