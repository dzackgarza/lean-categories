---
type: reference
title: "Provenance contract for FC11 Appendix A"
description: "# Provenance contract for FC11 Appendix A"
tags:
- project
- reference
...
---
# Provenance contract for FC11 A

## Provenance contract for FC11 A

- Canonical source block: FC11 Peters–Sterk Appendix A, “Algebra, Number Theory, and Symplectic Preliminaries”, `FC11-A-U001`–`FC11-A-U053`, 53 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 53/53 successful.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 24, `project-existing` 7, `package-import` 0, `reference-port` 0, `unmatched` 22; total 53.
