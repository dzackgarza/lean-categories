---
type: reference
title: "Provenance contract for FC11 C16"
description: "# Provenance contract for FC11 C16"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C16

## Provenance contract for FC11 C16

- Canonical source block: FC11 Peters–Sterk Chapter 16, “The Structure of Orthogonal Groups I, Vector Spaces”, `FC11-C16-U001`–`FC11-C16-U042`, 42 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/42 successful, 42 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 9, `project-existing` 1, `package-import` 0, `reference-port` 0, `unmatched` 32; total 42.
