---
type: reference
title: "Provenance contract for FC11 C10"
description: "# Provenance contract for FC11 C10"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C10

## Provenance contract for FC11 C10

- Canonical source block: FC11 Peters–Sterk Chapter 10, “p-adic Lattices”, `FC11-C10-U001`–`FC11-C10-U021`, 21 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/21 successful, 21 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 1, `package-import` 0, `reference-port` 0, `unmatched` 20; total 21.
