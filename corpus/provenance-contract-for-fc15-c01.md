---
type: reference
title: Provenance contract for FC15 C01
description: '# Provenance contract for FC15 C01'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C01

- Canonical block: FC15 Humphreys Chapter 1. Finite reflection groups, `FC15-C01-U001`–`FC15-C01-U051`, exactly 51 unique contiguous rows.
...
- Route census: 2 mathlib, 3 reference-port, 46 unmatched. Every row has exactly one route. Positive rows: U022, U028, U030, U034, U038.
...
- `N=2026-09-08` marks scoped negatives for the family `finite reflection groups, Coxeter length/exchange, chambers/parabolics`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
