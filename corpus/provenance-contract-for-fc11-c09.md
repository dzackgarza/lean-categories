---
type: reference
title: "Provenance contract for FC11 C09"
description: "# Provenance contract for FC11 C09"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C09

## Provenance contract for FC11 C09

- Canonical source block: FC11 Peters–Sterk Chapter 9, “Symmetric and Quadratic Torsion Groups”, `FC11-C09-U001`–`FC11-C09-U028`, 28 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/28 successful, 28 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 1, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 27; total 28.
