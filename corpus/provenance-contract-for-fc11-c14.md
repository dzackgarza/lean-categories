---
type: reference
title: "Provenance contract for FC11 C14"
description: "# Provenance contract for FC11 C14"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C14

## Provenance contract for FC11 C14

- Canonical source block: FC11 Peters–Sterk Chapter 14, “Spinor Equivalence”, `FC11-C14-U001`–`FC11-C14-U050`, 50 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 3, `project-existing` 11, `package-import` 0, `reference-port` 0, `unmatched` 36; total 50.
