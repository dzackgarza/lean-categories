---
type: reference
title: Provenance contract for FC15 C04
description: '# Provenance contract for FC15 C04'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C04

- Canonical block: FC15 Humphreys Chapter 4. Affine reflection groups, `FC15-C04-U001`–`FC15-C04-U030`, exactly 30 unique contiguous rows.
...
- Route census: 30 unmatched. Every row has exactly one route. Positive rows: none.
...
- `N=2026-09-08` marks scoped negatives for the family `affine Weyl groups, alcoves, affine Coxeter systems`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
