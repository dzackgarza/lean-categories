---
type: reference
title: "Provenance contract for FC11 C18"
description: "# Provenance contract for FC11 C18"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C18

## Provenance contract for FC11 C18

- Canonical source block: FC11 Peters–Sterk Chapter 18, “Applications to Singularities”, `FC11-C18-U001`–`FC11-C18-U049`, 49 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/49 successful, 49 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 17, `project-existing` 1, `package-import` 0, `reference-port` 0, `unmatched` 31; total 49.
