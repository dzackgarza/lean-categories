---
type: reference
title: "Provenance contract for FC11 Appendix B"
description: "# Provenance contract for FC11 Appendix B"
tags:
- project
- reference
...
---
# Provenance contract for FC11 B

## Provenance contract for FC11 B

- Canonical source block: FC11 Peters–Sterk Appendix B, “Complex Surface Preliminaries”, `FC11-B-U001`–`FC11-B-U047`, 47 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 7/47 successful, 40 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 0, `package-import` 0, `reference-port` 1, `unmatched` 46; total 47.
