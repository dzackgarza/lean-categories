---
type: reference
title: Provenance contract for FC15 C06
description: '# Provenance contract for FC15 C06'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C06

- Canonical block: FC15 Humphreys Chapter 6. Special cases, `FC15-C06-U001`–`FC15-C06-U022`, exactly 22 unique contiguous rows.
...
- Route census: 22 unmatched. Every row has exactly one route. Positive rows: none.
...
- `N=2026-09-08` marks scoped negatives for the family `finite/affine/hyperbolic Coxeter geometric representation and classification`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
