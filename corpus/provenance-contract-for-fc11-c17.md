---
type: reference
title: "Provenance contract for FC11 C17"
description: "# Provenance contract for FC11 C17"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C17

## Provenance contract for FC11 C17

- Canonical source block: FC11 Peters–Sterk Chapter 17, “The Structure of Orthogonal Groups II, Lattices”, `FC11-C17-U001`–`FC11-C17-U050`, 50 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/50 successful, 50 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 4, `package-import` 0, `reference-port` 0, `unmatched` 46; total 50.
