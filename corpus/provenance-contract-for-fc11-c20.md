---
type: reference
title: "Provenance contract for FC11 C20"
description: "# Provenance contract for FC11 C20"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C20

## Provenance contract for FC11 C20

- Canonical source block: FC11 Peters–Sterk Chapter 20, “Automorphisms and Group Actions on K3 Surfaces”, `FC11-C20-U001`–`FC11-C20-U082`, 82 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/82 successful, 82 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 1, `package-import` 0, `reference-port` 0, `unmatched` 81; total 82.
