---
type: reference
title: Provenance contract for FC15 C03
description: '# Provenance contract for FC15 C03'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C03

- Canonical block: FC15 Humphreys Chapter 3. Polynomial invariants of finite reflection groups, `FC15-C03-U001`–`FC15-C03-U045`, exactly 45 unique contiguous rows.
...
- Route census: 45 unmatched. Every row has exactly one route. Positive rows: none.
...
- `N=2026-09-08` marks scoped negatives for the family `finite-group polynomial invariants, Reynolds operator, Chevalley–Shephard–Todd, exponents`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
