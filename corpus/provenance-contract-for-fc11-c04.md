---
type: reference
title: "Provenance contract for FC11 C04"
description: "# Provenance contract for FC11 C04"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C04

## Provenance contract for FC11 C04

- Canonical source block: FC11 Peters–Sterk Chapter 4, “Graph Lattices and Topological Applications”, `FC11-C04-U001`–`FC11-C04-U072`, 72 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 60/72 successful, 12 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 5, `project-existing` 1, `package-import` 0, `reference-port` 0, `unmatched` 66; total 72.
