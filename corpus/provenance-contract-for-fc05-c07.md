...
- Mapping discovery was refreshed on 2026-09-14 against formalization-corpus index `2ebd72a616f97b1c30bcae966d02df6763f4b684`, current Mathlib `d0a6fafa3cdb0a09944ec57001c21e1ef4d0bc5e`, and current TauCeti `660a212aa624681385788fb838c39940e3e72269`. U047's Sweep-III construction layer is no longer a greenfield obligation: `U(g)`, `Λ^p g`, their tensor product, the UEA augmentation, and the initial multiplication map are direct Mathlib constructions, so the row is promoted to `[definition-only] mathlib`; freeness remains theorem work, and current TauCeti PBW still states that the ordered-monomial development proves only the spanning half while linear independence/full PBW remains outstanding. U048 remains unmatched after all-degree Chevalley--Eilenberg searches: current Mathlib has only low-degree cochains and explicitly lists comparison to the C--E complex as future work, current TauCeti has no C--E complex file, and indexed non-Lean hits were unrelated. U068 likewise remains unmatched after free-presentation/universal-central-extension searches; no checked source constructs the perfect restriction `[f,f]/[r,f]` and its central-extension package.
