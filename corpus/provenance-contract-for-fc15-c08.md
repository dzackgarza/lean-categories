---
type: reference
title: Provenance contract for FC15 C08
description: '# Provenance contract for FC15 C08'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C08

- Canonical block: FC15 Humphreys Chapter 8. Complements, `FC15-C08-U001`–`FC15-C08-U040`, exactly 40 unique contiguous rows.
...
- Route census: 1 mathlib, 39 unmatched. Every row has exactly one route. Positive rows: U015.
...
- `N=2026-09-08` marks scoped negatives for the family `word/reflection subgroups, Bruhat Möbius/shellability, affine series, Weyl representations and Schur multiplier`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
