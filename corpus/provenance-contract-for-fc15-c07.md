---
type: reference
title: Provenance contract for FC15 C07
description: '# Provenance contract for FC15 C07'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C07

- Canonical block: FC15 Humphreys Chapter 7. Hecke algebras and Kazhdan–Lusztig polynomials, `FC15-C07-U001`–`FC15-C07-U044`, exactly 44 unique contiguous rows.
...
- Route census: 44 unmatched. Every row has exactly one route. Positive rows: none.
...
- `N=2026-09-08` marks scoped negatives for the family `generic Coxeter Hecke algebra, R-polynomials, Kazhdan–Lusztig basis/polynomials/cells`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
