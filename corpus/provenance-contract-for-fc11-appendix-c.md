---
type: reference
title: "Provenance contract for FC11 Appendix C"
description: "# Provenance contract for FC11 Appendix C"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C

## Provenance contract for FC11 C

- Canonical source block: FC11 Peters–Sterk Appendix C, “Local Quadratic Forms and Dyadic Normal Forms”, `FC11-C-U001`–`FC11-C-U018`, 18 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch was run across all three appendices; successful Appendix-A results were checked against pinned local Mathlib. The service returned HTTP 429 from Appendix B onward, so those errors were not used as negative evidence. Project and pinned/current Mathlib were searched locally by source family, together with the source atlas, package/reference families, and broad Lean repository search surfaces.
- Unit-level LeanSearch captures: 0/18 successful, 18 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 1, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 17; total 18.
