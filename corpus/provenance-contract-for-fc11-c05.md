---
type: reference
title: "Provenance contract for FC11 C05"
description: "# Provenance contract for FC11 C05"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C05

## Provenance contract for FC11 C05

- Canonical source block: FC11 Peters–Sterk Chapter 5, “Forms Related to Coding Theory and Number Theory”, `FC11-C05-U001`–`FC11-C05-U067`, 67 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/67 successful, 67 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 14, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 53; total 67.
