---
type: reference
title: "Provenance contract for FC11 C19"
description: "# Provenance contract for FC11 C19"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C19

## Provenance contract for FC11 C19

- Canonical source block: FC11 Peters–Sterk Chapter 19, “Application to Moduli of K3 Surfaces”, `FC11-C19-U001`–`FC11-C19-U051`, 51 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/51 successful, 51 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 0, `project-existing` 2, `package-import` 0, `reference-port` 0, `unmatched` 49; total 51.
