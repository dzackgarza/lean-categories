---
type: reference
title: Provenance contract for FC15 C05
description: '# Provenance contract for FC15 C05'
tags:
- project
- reference
...
---
# Provenance contract for FC15 C05

- Canonical block: FC15 Humphreys Chapter 5. Coxeter groups, `FC15-C05-U001`–`FC15-C05-U038`, exactly 38 unique contiguous rows.
...
- Route census: 3 mathlib, 2 reference-port, 33 unmatched. Every row has exactly one route. Positive rows: U001, U005, U006, U020, U021.
...
- `N=2026-09-08` marks scoped negatives for the family `abstract Coxeter systems, length, exchange, Bruhat, parabolics and Tits cone`. Strict whole-row semantics reject adjacent ingredients and executable non-Lean libraries as formalization matches.
