---
type: reference
title: "Provenance contract for FC11 C07"
description: "# Provenance contract for FC11 C07"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C07

## Provenance contract for FC11 C07

- Canonical source block: FC11 Peters–Sterk Chapter 7, “Reflections and the Witt Decomposition”, `FC11-C07-U001`–`FC11-C07-U025`, 25 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/25 successful, 25 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 3, `project-existing` 0, `package-import` 0, `reference-port` 0, `unmatched` 22; total 25.
