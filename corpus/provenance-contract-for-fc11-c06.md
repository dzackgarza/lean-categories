---
type: reference
title: "Provenance contract for FC11 C06"
description: "# Provenance contract for FC11 C06"
tags:
- project
- reference
...
---
# Provenance contract for FC11 C06

## Provenance contract for FC11 C06

- Canonical source block: FC11 Peters–Sterk Chapter 6, “Symmetric and Quadratic Forms Revisited”, `FC11-C06-U001`–`FC11-C06-U062`, 62 units, exact canonical order from [[foundational-corpus-units-fc11-peters-sterk]].
...
- Unit-level LeanSearch captures: 0/62 successful, 62 service errors.
...
- Route totals after the 2026-09-13 exact-route remap: `mathlib` 28, `project-existing` 8, `package-import` 0, `reference-port` 1, `unmatched` 25; total 62.
