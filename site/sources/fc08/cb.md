...
90 units. 81 have a Lean owner; 9 do not.

| Route | Units | Share | Meaning |
| --- | ---: | ---: | --- |
| [`mathlib`]{.route-mathlib} | 81 | 90% | Mathlib owns the unit outright. |
| [`unmatched`]{.route-unmatched} | 9 | 10% | No checked Lean owner was found. |
| **total** | **90** | | |
...
::: {.unit-meta}
`FC08-CB-U001` · Appendix B, § Vector Spaces; source L18604 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-lean}
**In Lean.** [`Mathlib/Algebra/Module/Defs.lean::Module`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Module/Defs.html) — `Module ℝ V` is Mathlib’s canonical real-vector-space structure, with addition supplied by the additive-group structure and scalar multiplication/laws by `Module`.
:::

### **Definition/convention — vectors** {#fc08-cb-u002}

::: {.unit-meta}
`FC08-CB-U002` · Appendix B, § Vector Spaces; source L18632 · [`unmatched`]{.route-unmatched}
:::
...
::: {.unit-lean}
**Not in Lean.** none; no complete checked declaration under strict bundle semantics — This row is solely source terminology (“vectors” versus “scalars”), not a mathematical structure or theorem with a canonical Lean declaration; the underlying `Module` is mapped in U001.
:::
...
::: {.unit-meta}
`FC08-CB-U003` · Appendix B, § Vector Spaces; source L18634 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U005` · Appendix B, § Vector Spaces; source L18638 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-lean}
**In Lean.** [`Mathlib/Analysis/Convex/Basic.lean::Convex`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Analysis/Convex/Basic.html) — `Convex ℝ B` is exactly closure of `B` under real line segments/convex combinations, equivalent to Lee’s segment definition.
:::

### **Convention/notation — linearly dependent** {#fc08-cb-u006}

::: {.unit-meta}
`FC08-CB-U006` · Appendix B, § Bases and Dimension; source L18642 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U008` · Appendix B, § Bases and Dimension; source L18656 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U010` · Appendix B, § Bases and Dimension; source L18666 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U011` · Appendix B, § Bases and Dimension; source L18668 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U014` · Appendix B, § Bases and Dimension; source L18694 · [`unmatched`]{.route-unmatched}
:::
...
::: {.unit-meta}
`FC08-CB-U015` · Appendix B, § Bases and Dimension; source L18696 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U017` · Appendix B, § Bases and Dimension; source L18710 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U022` · Appendix B, § Linear Maps; source L18760 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-lean}
**In Lean.** [`Mathlib/LinearAlgebra/Projection.lean::Submodule.projectionOnto, Submodule.ker_projectionOnto, Submodule.range_projectionOnto`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/LinearAlgebra/Projection.html) — Given complementary submodules, `projectionOnto` is the unique linear projection onto the first summand and Mathlib proves its kernel is the second summand and its range is all of the target subtype.
:::

### **Construction/definition — projection onto S** {#fc08-cb-u023}

::: {.unit-meta}
`FC08-CB-U023` · Appendix B, § Linear Maps; source L18766 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U024` · Appendix B, § Linear Maps; source L18768 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-lean}
**In Lean.** [`Mathlib/Algebra/Module/Equiv/Defs.lean::LinearEquiv`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Module/Equiv/Defs.html) — `LinearEquiv` is a bijective linear map with a linear inverse, exactly Lee’s isomorphism/invertibility notion for vector spaces.
:::

### **Definition/convention — invertible** {#fc08-cb-u025}

::: {.unit-meta}
`FC08-CB-U025` · Appendix B, § Linear Maps; source L18774 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U026` · Appendix B, § Linear Maps; source L18776 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U030` · Appendix B, § Linear Maps; source L18842 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U031` · Appendix B, § Linear Maps; source L18848 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U032` · Appendix B, § Linear Maps; source L18850 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U037` · Appendix B, § Change of Basis; source L18904 · [`mathlib`]{.route-mathlib}
:::

If V and W are real vector spaces, the set L ( V ; W ) of linear maps from V to W is a real vector space under the operations

::: {.unit-lean}
**In Lean.** [`Mathlib/Algebra/Module/LinearMap/Defs.lean::LinearMap`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Module/LinearMap/Defs.html) — `V →ₗ[ℝ] W` carries the pointwise module structure, exactly Lee’s vector space `L(V,W)` of linear maps.
:::

### **Definition/convention — rank of T** {#fc08-cb-u038}

::: {.unit-meta}
`FC08-CB-U038` · Appendix B, § Change of Basis; source L18912 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U040` · Appendix B, § Change of Basis; source L18942 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U041` · Appendix B, § Change of Basis; source L18966 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U044` · Appendix B, § Change of Basis; source L18988 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U046` · Appendix B, § The Determinant; source L18998 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U048` · Appendix B, § The Determinant; source L19002 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U051` · Appendix B, § The Determinant; source L19034 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U052` · Appendix B, § The Determinant; source L19088 · [`unmatched`]{.route-unmatched}
:::
...
::: {.unit-lean}
**Not in Lean.** none; no complete checked declaration under strict bundle semantics — Mathlib has the actual row/column update and swap operations and their determinant laws, but no canonical object corresponding to Lee’s source-specific collective terminology “elementary row/column operations.”
:::
...
::: {.unit-meta}
`FC08-CB-U053` · Appendix B, § The Determinant; source L19106 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U054` · Appendix B, § The Determinant; source L19114 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U055` · Appendix B, § The Determinant; source L19120 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U056` · Appendix B, § The Determinant; source L19124 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U057` · Appendix B, § The Determinant; source L19134 · after [`FC08-CB-U056`](#fc08-cb-u056) · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U059` · Appendix B, § The Determinant; source L19172 · [`unmatched`]{.route-unmatched}
:::
...
::: {.unit-lean}
**Not in Lean.** none; no complete checked declaration under strict bundle semantics — Mathlib represents signed minors through submatrices and adjugate entries, but does not expose Lee’s exact `M_i^j` / cofactor terminology as a canonical standalone construction for this row. Strict whole-row semantics reject proper subsets and substantive reconstruction from adjacent generic ingredients.
:::
...
::: {.unit-meta}
`FC08-CB-U060` · Appendix B, § The Determinant; source L19174 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U063` · Appendix B, § The Determinant; source L19198 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U064` · Appendix B, § The Determinant; source L19206 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U065` · Appendix B, § Inner Products and Norms; source L19232 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U067` · Appendix B, § Inner Products and Norms; source L19258 · [`unmatched`]{.route-unmatched}
:::
...
::: {.unit-meta}
`FC08-CB-U068` · Appendix B, § Inner Products and Norms; source L19264 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U070` · Appendix B, § Inner Products and Norms; source L19280 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U073` · Appendix B, § Inner Products and Norms; source L19320 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U076` · Appendix B, § Norms; source L19334 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-lean}
**Not in Lean.** none; no complete checked declaration under strict bundle semantics — Mathlib’s finite-dimensional theory proves continuity of all linear maps and thereby equivalence of norms, but its own source notes that norm equivalence is not packaged explicitly as Lee’s two-constant predicate. No canonical owner for the definition row was found. Strict whole-row semantics reject proper subsets and substantive reconstruction from adjacent generic ingredients.
:::
...
::: {.unit-meta}
`FC08-CB-U079` · Appendix B, § Norms; source L19376 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-lean}
**In Lean.** [`Mathlib/Analysis/Normed/Operator/BoundedLinearMaps.lean::IsBoundedLinearMap, isBoundedLinearMap_iff`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Analysis/Normed/Operator/BoundedLinearMaps.html) — `IsBoundedLinearMap` is explicitly the unbundled predicate that a linear map has a constant `C>0` with `‖Tv‖ ≤ C‖v‖`, exactly Lee’s bounded linear map.
:::

### **Construction/definition — source terminology/construction** {#fc08-cb-u080}

::: {.unit-meta}
`FC08-CB-U080` · Appendix B, § Direct Products and Direct Sums; source L19388 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U082` · Appendix B, § Direct Products and Direct Sums; source L19402 · [`unmatched`]{.route-unmatched}
:::
...
::: {.unit-lean}
**Not in Lean.** none; no complete checked declaration under strict bundle semantics — Pi types and coordinate projections are canonical Lean structures, but the row also asserts the axiom-of-choice nonemptiness theorem for arbitrary nonempty indexed families. No single checked declaration owns that whole set-theoretic bundle. Strict whole-row semantics reject proper subsets and substantive reconstruction from adjacent generic ingredients.
:::
...
::: {.unit-meta}
`FC08-CB-U083` · Appendix B, § Direct Products and Direct Sums; source L19408 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U084` · Appendix B, § Direct Products and Direct Sums; source L19416 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U087` · Appendix B, § Direct Products and Direct Sums; source L19424 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U088` · Appendix B, § Direct Products and Direct Sums; source L19428 · [`mathlib`]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC08-CB-U090` · Appendix B, § Direct Products and Direct Sums; source L19438 · [`mathlib`]{.route-mathlib}
:::
