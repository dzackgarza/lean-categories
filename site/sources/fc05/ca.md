...
This chapter contains 26 definitions, 1 theorem, 12 examples, 4 constructions, 1 convention and 8 other statements.

Of the 52 statements checked against Lean, 39 are formalized somewhere and 13 are not.

| Status | Statements | Share | What it means |
| --- | ---: | ---: | --- |
| [in Mathlib]{.route-mathlib} | 39 | 75% | Mathlib states and proves it. |
| [not formalized]{.route-unmatched} | 13 | 25% | A documented search found no Lean statement of it anywhere. |
| **checked in total** | **52** | | |
...
::: {.unit-meta}
`FC05-CA-U001` · §A.1 Categories; pp. 417–420; L11875 · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U003` · §A.1 Categories; pp. 417–420; L11879–11885 · after [`FC05-CA-U001`](#fc05-ca-u001) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U005` · §A.1 Categories; pp. 417–420; L11895 · after [`FC05-CA-U001`](#fc05-ca-u001) · [not formalized]{.route-unmatched}
:::
...
::: {.unit-meta}
`FC05-CA-U006` · §A.1 Categories; pp. 417–420; L11897–11899 · after [`FC05-CA-U001`](#fc05-ca-u001) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U011` · §A.1 Categories; pp. 417–420; L11915–11917 · after [`FC05-CA-U009`](#fc05-ca-u009) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-lean}
**Formalized.** [`Mathlib/CategoryTheory/Functor/Basic.lean::Functor`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Functor/Basic.html) — Pinned Mathlib's `Functor` preserves identities and composition on the nose and supplies object/morphism maps, exactly the source definition.
:::

### Construction — identity functor and Cat {#fc05-ca-u013}

::: {.unit-meta}
`FC05-CA-U013` · §A.2 Functors; pp. 421–422; L11937 · after [`FC05-CA-U004`](#fc05-ca-u004), [`FC05-CA-U012`](#fc05-ca-u012) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U023` · §A.3 Natural Transformations; p. 423; L11961–11967 · after [`FC05-CA-U012`](#fc05-ca-u012), [`FC05-CA-U005`](#fc05-ca-u005) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U025` · §A.3 Natural Transformations; p. 423; L11975 · after [`FC05-CA-U023`](#fc05-ca-u023), [`FC05-CA-U020`](#fc05-ca-u020) · [not formalized]{.route-unmatched}
:::
...
::: {.unit-meta}
`FC05-CA-U026` · §A.3 Natural Transformations; p. 423; L11977 · after [`FC05-CA-U013`](#fc05-ca-u013), [`FC05-CA-U023`](#fc05-ca-u023) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U030` · §A.4 Abelian Categories; pp. 424–426; L11997–12003 · after [`FC05-CA-U029`](#fc05-ca-u029), [`FC05-CA-U006`](#fc05-ca-u006), [`FC05-CA-U008`](#fc05-ca-u008) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U035` · §A.4 Abelian Categories; pp. 424–426; L12033–12034 · after [`FC05-CA-U033`](#fc05-ca-u033), [`FC05-CA-U006`](#fc05-ca-u006) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U037` · §A.4 Abelian Categories; pp. 424–426; L12052–12063 · after [`FC05-CA-U032`](#fc05-ca-u032), [`FC05-CA-U033`](#fc05-ca-u033) · [not formalized]{.route-unmatched}
:::
...
::: {.unit-meta}
`FC05-CA-U038` · §A.4 Abelian Categories; pp. 424–426; L12066–12068 · after [`FC05-CA-U037`](#fc05-ca-u037), [`FC05-C02-U070`](c02.html#fc05-c02-u070) · [not formalized]{.route-unmatched}
:::
...
::: {.unit-meta}
`FC05-CA-U039` · §A.5 Limits and Colimits; pp. 427–428; L12076 · after [`FC05-CA-U012`](#fc05-ca-u012), [`FC05-CA-U011`](#fc05-ca-u011) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U046` · §A.5 Limits and Colimits; pp. 427–428; L12096 · after [`FC05-CA-U041`](#fc05-ca-u041), [`FC05-CA-U044`](#fc05-ca-u044) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U047` · §A.5 Limits and Colimits; pp. 427–428; L12098 · after [`FC05-CA-U044`](#fc05-ca-u044), [`FC05-CA-U046`](#fc05-ca-u046) · [in Mathlib]{.route-mathlib}
:::
...
::: {.unit-meta}
`FC05-CA-U050` · §A.6 Adjoint Functors; pp. 429–431; L12122–12132 · after [`FC05-CA-U048`](#fc05-ca-u048), [`FC05-CA-U023`](#fc05-ca-u023) · [in Mathlib]{.route-mathlib}
:::
