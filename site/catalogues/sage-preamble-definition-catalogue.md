...
A checkbox is a term to route through the reuse gate in [`AGENTS.md`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=AGENTS.md#doc): close it when the notion has a principled owner in this repository, pinned Mathlib, or a registered external formalization. The active work queue is [`TODO.md`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=TODO.md#doc); the corpus-wide foundation is governed by `PLAN-FOUNDATIONAL-CORPUS-CATALOGUE-SWEEP`, `PLAN-FOUNDATIONAL-CORPUS-DEFINITION-SWEEP`, and `PLAN-FOUNDATIONAL-CORPUS-THEOREM-SWEEP`. This Sage catalogue is supplementary source material unless admitted to the frozen foundational corpus.
...
- [x] **Sets (owned)** with axioms **Finite / Countable / Infinite / Uncountable / TotallyOrdered** ⚠ Countable = chosen enumeration data (source is explicit); TotallyOrdered carried as structure, not placement — the file's own statement of the axiom-vs-structure distinction
  - Mathlib: [`Set.Finite`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Set.Finite#doc) — [`Mathlib/Data/Set/Finite/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Data/Set/Finite/Basic.html)
  - Mathlib: [`Set.Infinite`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Set.Infinite#doc) — [`Mathlib/Data/Set/Finite/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Data/Set/Finite/Basic.html)
  - Mathlib: [`Set.Countable`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Set.Countable#doc) — [`Mathlib/Data/Set/Countable.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Data/Set/Countable.html)
  - Mathlib: `Uncountable` — [`Mathlib/Data/Countable/Defs.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Data/Countable/Defs.html)
  - Mathlib: `IsTotal` — [`Mathlib/Order/Defs/Unbundled.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Order/Defs/Unbundled.html)
...
- [x] **ordered sets; Δ[n]** — the standard finite ordered sets, Δ[ℵ₀] = ℕ ⚠ "simplex indexing objects" with no face/degeneracy maps: Δ is not a category here
  - Mathlib: `SimplexCategory` — [`Mathlib/AlgebraicTopology/SimplexCategory/Defs.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/AlgebraicTopology/SimplexCategory/Defs.html)
- [x] **Cardinals ℵ_n** ⚠ `ℵ₁ = continuum` hard-codes the continuum hypothesis into the vocabulary — the most consequential error found
  - Mathlib: [`Cardinal.aleph`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Cardinal.aleph#doc) — [`Mathlib/SetTheory/Cardinal/Aleph.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/SetTheory/Cardinal/Aleph.html)
...
- [x] **Cat** — category of categories ⚠ no morphisms: no functors between categories are ever constructed; its 21 constructions are installed on every category, bypassing the refine discipline
  - Mathlib: `Cat` — [`Mathlib/CategoryTheory/Category/Cat.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Category/Cat.html)
- [x] **ArrowCategory Ar(C)** — objects = morphisms, morphisms = commuting squares ⚠ the squares are never constructed (only an `is_commuting_square` predicate on generators); dom/cod functors named, absent
  - Mathlib: `Arrow` — [`Mathlib/CategoryTheory/Comma/Arrow.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Comma/Arrow.html)
- [x] **IsoArrowCategory; Core(C)** — declared-isomorphism arrows; maximal subgroupoid ⚠ core's fewer-arrows nature unexpressible in the object-based subcategory relation; `is_isomorphism` true by placement
  - Mathlib: `Core` — [`Mathlib/CategoryTheory/Core.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Core.html)
- [x] **Isomorphism(f, g)** — invertibility declared with both round trips checked on generators; iso as a property of the arrow, not the objects (the clean separation in these files) ⚠ only for objects with a sole structure-generating family
  - Mathlib: `Iso` — [`Mathlib/CategoryTheory/Iso.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Iso.html)
...
- [x] **SliceOver C/X; CosliceUnder X\C** ⚠ declared subcategories of C (false: the relation is a forgetful functor); no triangle morphisms defined ⚠ Slice mutates the domain in place: (A, f) conflated with A, one slice at a time
  - Mathlib: `Over` — [`Mathlib/CategoryTheory/Comma/Over/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Comma/Over/Basic.html)
  - Mathlib: `Under` — [`Mathlib/CategoryTheory/Comma/Over/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Comma/Over/Basic.html)
...
- [x] **Kernel / Cokernel categories** ⚠ parameterized by f, universal property never constructed or checked
  - Mathlib: `HasKernel` — [`Mathlib/CategoryTheory/Limits/Shapes/Kernels.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Shapes/Kernels.html)
  - Mathlib: `kernel` — [`Mathlib/CategoryTheory/Limits/Shapes/Kernels.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Shapes/Kernels.html)
  - Mathlib: `cokernel` — [`Mathlib/CategoryTheory/Limits/Shapes/Kernels.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Shapes/Kernels.html)
...
- [x] **Cone / Cocone / Product / Coproduct / Biproduct / DirectSum** ⚠ no universal property checked anywhere; cones don't commute with transitions; biproduct relation π_j ι_i = δ_ij stated, unchecked; Cone declared subcategory of DirectedSystem (false containment)
  - Mathlib: `Cone` — [`Mathlib/CategoryTheory/Limits/Cones.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Cones.html)
  - Mathlib: `Cocone` — [`Mathlib/CategoryTheory/Limits/Cones.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Cones.html)
  - Mathlib: `HasProduct` — [`Mathlib/CategoryTheory/Limits/Shapes/Products.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Shapes/Products.html)
  - Mathlib: `HasCoproduct` — [`Mathlib/CategoryTheory/Limits/Shapes/Products.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Shapes/Products.html)
  - Mathlib: `HasBiproduct` — [`Mathlib/CategoryTheory/Limits/Shapes/Biproducts.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Limits/Shapes/Biproducts.html)
...
- [x] **BaseChangeFunctor** − ⊗_R S : Mod(R) → Mod(S); **fraction_field_base_change** (rationalization) ⚠ implemented only for modules free on their framing
  - Mathlib: [`ModuleCat.extendScalars`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=ModuleCat.extendScalars#doc) — [`Mathlib/Algebra/Category/ModuleCat/ChangeOfRings.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Category/ModuleCat/ChangeOfRings.html) (line 400)
- [x] **RestrictionOfScalarsFunctor** ⚠ object-level only, and the object action returns the free R-module on the same generators — not restriction of scalars; docstring and implementation contradict each other
  - Mathlib: `RestrictScalars` — [`Mathlib/Algebra/Algebra/RestrictScalars.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Algebra/RestrictScalars.html)
- [x] **BaseChangeAdjunction F ⊣ G** with unit m ↦ m ⊗ 1 ⚠ stated over the broken G; triangle identities and naturality never checked; hom-set bijections left abstract
  - Mathlib: [`ModuleCat.extendRestrictScalarsAdj`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=ModuleCat.extendRestrictScalarsAdj#doc) — [`Mathlib/Algebra/Category/ModuleCat/ChangeOfRings.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Category/ModuleCat/ChangeOfRings.html) (line 884)
- [x] **FreeModuleFunctorClass F_R : Set → Mod(R)** — honest; cached so F(dom f) *is* the domain of F(f) (the one place equality-vs-isomorphism is enforced)
  - Mathlib: [`ModuleCat.free`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=ModuleCat.free#doc) — [`Mathlib/Algebra/Category/ModuleCat/Adjunctions.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Category/ModuleCat/Adjunctions.html)
- [x] **UnderlyingSetOfGroupFunctor U : Grp → Set** — honest
  - Mathlib: `GrpCat` — [`Mathlib/Algebra/Category/Grp/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Category/Grp/Basic.html)
- [x] **ForgetfulFunctorClass U : Mod(R) → Set** — honest ⚠ morphism action enumerates the underlying set: unconstructible for infinite modules
  - Mathlib: `forget (ModuleCat.{u} R)` — [`Mathlib/Algebra/Category/ModuleCat/Adjunctions.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Category/ModuleCat/Adjunctions.html)
- [x] **FreeForgetfulAdjunction F_R ⊣ U** — unit, counit, both hom-set bijections implemented ⚠ counit enumerates U(M): finite modules only; triangle identities stated in prose, never represented
  - Mathlib: [`ModuleCat.adj`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=ModuleCat.adj#doc) — [`Mathlib/Algebra/Category/ModuleCat/Adjunctions.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Category/ModuleCat/Adjunctions.html)
...
- [x] **RingCenterFunctor Z : core(Rings) → CRings** — honest; source is the core precisely because Z is not functorial on general ring maps (explicit counterexample recorded: ℚ[t] → Λ, t ↦ e₁) ⚠ codomain inconsistent between object and morphism halves
  - Mathlib: [`Subring.center`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Subring.center#doc) — [`Mathlib/Algebra/Ring/Subring/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Ring/Subring/Basic.html)
...
- [x] **OwnedSemirings / OwnedRngs / OwnedRings / OwnedDivisionRings / OwnedFields** — the ring tower (semiring = mult. monoid over add. comm. monoid; rng; unital ring as the join; division ring; field)
  - Mathlib: `Semiring` — [`Mathlib/Algebra/Ring/Defs.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Ring/Defs.html)
  - Mathlib: `NonUnitalRing` — [`Mathlib/Algebra/Ring/Defs.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Ring/Defs.html)
...
- [x] **Algebras(R)** — associative unital R-algebras; defining datum the structure map R → Z(A) ⚠ no morphism side at all; membership decided by coercion, weaker than the declared structure map
  - Mathlib: `Algebra` — [`Mathlib/Algebra/Algebra/Defs.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Algebra/Defs.html)
...
- [x] **TensorAlgebras / SymmetricAlgebras / AlternatingAlgebras / DividedPowerAlgebras** (R) — the four flavors; Γ stated via the universal property Hom(Γ²M, W) ≅ quadratic maps ⚠ documented, never constructed; Λ never declared graded-commutative
  ...
  - Mathlib: `SymmetricAlgebra` — [`Mathlib/LinearAlgebra/SymmetricAlgebra/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/LinearAlgebra/SymmetricAlgebra/Basic.html)
  - Mathlib: `ExteriorAlgebra` — [`Mathlib/LinearAlgebra/ExteriorAlgebra/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/LinearAlgebra/ExteriorAlgebra/Basic.html)
  - Mathlib: `DividedPowerAlgebra` — [`Mathlib/RingTheory/DividedPowerAlgebra/Init.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/RingTheory/DividedPowerAlgebra/Init.html)
...
- [x] **OwnedNumberFields()** — K = ℚ[x]/(f), f irreducible, presented on a primitive element; irreducibility asserted at construction, then placed in fields
  - Mathlib: `NumberField` — [`Mathlib/NumberTheory/NumberField/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/NumberTheory/NumberField/Basic.html)
...
- [x] **FreeAlgebraOnSet FreeAlg_R(S)** — free on Mon(S) as a module, free on S as an algebra, both framings carried
  - Mathlib: `FreeAlgebra` — [`Mathlib/Algebra/FreeAlgebra.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/FreeAlgebra.html)
- [x] **hom (universal property)** — Hom_{R-Alg}(FreeAlg_R(S), A) ≅ Hom_Set(S, U(A)) ⚠ produced arrow is a ModuleMorphism; multiplicativity never a checked law
  - Mathlib: [`FreeAlgebra.lift`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=FreeAlgebra.lift#doc) — [`Mathlib/Algebra/FreeAlgebra.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/FreeAlgebra.html)
...
- [x] **γ_a(x) divided powers; divided_square γ₂(x)** — the operation quadratic forms are built from
  - Mathlib: `dpow` — [`Mathlib/RingTheory/DividedPowers/SubDPIdeal.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/RingTheory/DividedPowers/SubDPIdeal.html)
...
- [x] **is_galois / galois_group** ⚠ returns the group of the defining polynomial — the normal closure's group when K/ℚ is not normal; one method, two different groups
  - Mathlib: `IsGalois` — [`Mathlib/FieldTheory/Galois/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/FieldTheory/Galois/Basic.html) (line 58); [`Polynomial.Gal`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Polynomial.Gal#doc) — [`Mathlib/FieldTheory/PolynomialGaloisGroup.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/FieldTheory/PolynomialGaloisGroup.html) (line 55)
...
- [x] **integral_basis** ⚠ returns the power basis of ℤ[α], not of 𝒪_K, whenever the index is nontrivial; disconnected from `ring_of_integers` (engine's maximal order) — two incompatible integral structures
  - Mathlib: `integralBasis` — [`Mathlib/NumberTheory/NumberField/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/NumberTheory/NumberField/Basic.html) (line 394)
...
- [x] **is_central** — decided against a finite algebra generating set (centralizer is a subring)
  - Mathlib: [`Algebra.IsCentral`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Algebra.IsCentral#doc) — [`Mathlib/Algebra/Central/Defs.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Central/Defs.html) (line 67)
...
- [x] **ProfiniteGroups** — inverse limits of finite groups ⚠ no inverse system, topology, compactness, or total disconnectedness modeled; plain subcategory, not an axiom
  - Mathlib: `ProfiniteGrp` — [`Mathlib/Topology/Algebra/Category/ProfiniteGrp/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Topology/Algebra/Category/ProfiniteGrp/Basic.html) (line 44); [`ProfiniteGrp.of`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=ProfiniteGrp.of#doc) (line 82); [`ProfiniteGrp.Hom`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=ProfiniteGrp.Hom#doc) (line 102)
- [x] **AbsoluteGaloisGroups** — G_K = lim Gal(L/K)
  - Mathlib: `absoluteGaloisGroup` — [`Mathlib/FieldTheory/AbsoluteGaloisGroup.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/FieldTheory/AbsoluteGaloisGroup.html) (line 43); `absoluteGaloisGroupAbelianization` (line 59)
...
- [x] **AbsoluteGaloisGroup** — the *based* object G_{K,K̄,ι} = Aut_{ι(K)}(K̄), explicit π₁-basepoint analogy ⚠ eq/hash use only the base field, collapsing the based structure the class exists to record
  - Mathlib: `absoluteGaloisGroup` — [`Mathlib/FieldTheory/AbsoluteGaloisGroup.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/FieldTheory/AbsoluteGaloisGroup.html) (line 43)
...
- [x] **RingedSpaces** (X, 𝒪_X) ⚠ super-category Sets(); no topology or sheaf modeled anywhere; **LocallyRinged** axiom; **LocallyRingedSpaces**
  - Mathlib: `RingedSpace` — [`Mathlib/Geometry/RingedSpace/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Geometry/RingedSpace/Basic.html) (line 44); `SheafedSpace` — [`Mathlib/Geometry/RingedSpace/SheafedSpace.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Geometry/RingedSpace/SheafedSpace.html) (line 40); `LocallyRingedSpace` — [`Mathlib/Geometry/RingedSpace/LocallyRingedSpace.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Geometry/RingedSpace/LocallyRingedSpace.html) (line 43)
...
- [x] **structure_sheaf / underlying_space / stalk** — declared abstract ⚠ assert-false at every call
  - Mathlib: [`Spec.structureSheaf`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Spec.structureSheaf#doc) — [`Mathlib/AlgebraicGeometry/StructureSheaf.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/AlgebraicGeometry/StructureSheaf.html) (line 890); `stalk` — [`Mathlib/Topology/Sheaves/Stalks.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Topology/Sheaves/Stalks.html) (line 82); [`LocallyRingedSpace.toTopCat`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=LocallyRingedSpace.toTopCat#doc) — [`Mathlib/Geometry/RingedSpace/LocallyRingedSpace.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Geometry/RingedSpace/LocallyRingedSpace.html) (line 60)
...
- [x] **FreeModules(R); ProjectiveModules(R); TorsionModules(R)** ⚠ is_free/is_projective/is_torsion return True by placement; Free and Torsion route to Sage's Modules(R), not the owned one — ρ imposed inconsistently
  ...
  - Mathlib: [`Module.IsTorsion`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Module.IsTorsion#doc) — [`Mathlib/Algebra/Module/Torsion/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Module/Torsion/Basic.html)
...
- [x] **GradedModules(R); GradedAlgebras(R)** ⚠ grading assigned to chosen generators — grades the presentation, not the module; homogeneity of relations never required; A_iA_j ⊆ A_{i+j} stated, unimposed
  - Mathlib: `Gmodule` — [`Mathlib/Algebra/Module/GradedModule.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Module/GradedModule.html) (line 45); `GradedAlgebra` — [`Mathlib/RingTheory/GradedAlgebra/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/RingTheory/GradedAlgebra/Basic.html) (line 170)
...
- [x] **FreeResolution** 0 ← M ← F₀ ← F₁ ← 0 over a PID ⚠ exactness never checked
  - Mathlib: `ProjectiveResolution` — [`Mathlib/CategoryTheory/Preadditive/Projective/Resolution.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Preadditive/Projective/Resolution.html)
...
- [x] **FractionalIdeal** — R-submodule of Frac(R) on a finite family; ring_as_module(R); as_submodule ⚠ equality by generating tuple ((2,3) ≠ (1) in ℤ); `__contains__` tests the union of principal ideals, not the sum (1 ∈ (2,3) reported false); inverse only for principal; Dedekind arithmetic absent
  - Mathlib: `FractionalIdeal` — [`Mathlib/RingTheory/FractionalIdeal/Basic.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/RingTheory/FractionalIdeal/Basic.html) (line 83)
...
- [x] **orthogonal_complement** — left kernel of `Gram(N)·Aᵀ`. ⚠ Reads codomain Gram without asserting a form exists (source).
  - Mathlib: `orthogonal` — [`Mathlib/LinearAlgebra/BilinearForm/Orthogonal.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/LinearAlgebra/BilinearForm/Orthogonal.html) (line 146); `orthogonalBilin` — [`Mathlib/LinearAlgebra/SesquilinearForm/Orthogonal.lean`](https://leanprover-community.github.io/mathlib4_docs/Mathlib/LinearAlgebra/SesquilinearForm/Orthogonal.html) (line 48)
...
## [`tensors.sage`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=tensors.sage#doc)
...
- ⚠ [`Lattices.__classcall_private__`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=Lattices.__classcall_private__#doc) is category and object constructor in one callable
...
Named lattices in this tree: only `U`/`H` and the ADE root lattices from Cartan matrices; `E8`, `K3`, Enriques, Sterk-specific lattices live in [`catalogue.sage`](https://leanprover-community.github.io/mathlib4_docs/find/?pattern=catalogue.sage#doc). Vinberg is delegated to a vendored `vinal`; no elliptic/parabolic/Lannér subdiagram classification exists.
